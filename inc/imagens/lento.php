...
<div class="container">
	<form action="index.php?page=inc/imagens/lento" method="post" enctype="multipart/form-data" name="cadastro">
		...
		<div class="form-group">
            ...
            <div class="row text-center">
                <div class="col-md-12">
                    <div class="btn-group" role="group" aria-label="Basic example">
                        <button type="button" class="btn btn-secondary"><span id="quant_lenta">1</span></button>
            ...
            <input class="hidden" id="quant_imagens_lenta" value="1">
...
<script>
	$(function(){
		...
		$('#add_foto').click(function(){
			...
			conteudo +=	'		     	<div class="form-group">';
			conteudo +=	'		     		 <a href="javascript:void(0);" id="excluir-lenta-'+ x +'" data-number="' + x + '" class="btn btn-danger" title="Excluir" alt="Excluir">';
            ...
            total = parseInt($('#quant_imagens_lenta').val()) + 1;
            $('#quant_lenta').html( total );
            $('#quant_imagens_lenta').val( total );

			$('#excluir-lenta-'+x).click(function(){
